...
def operation():
    ...
    msg=game_font.render('Do you want one more? y or n', True, (255,255,0))
    msg_rect=msg.get_rect(center=(int(screen_width/2), int(screen_height/2)+30))
    screen.blit(msg, msg_rect)
    pygame.display.update()
